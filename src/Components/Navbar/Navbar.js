...
let cvIcon = "https://res.cloudinary.com/dleeu99na/image/upload/v1593753249/personal%20website/Images/cv-icon.png";
let logo = "https://res.cloudinary.com/dleeu99na/image/upload/v1593753249/personal%20website/Images/logo2.png";
let WhatsappIcon = "https://res.cloudinary.com/dleeu99na/image/upload/v1593753249/personal%20website/Images/whatsapp-icon.png";
let linkedinIcon = "https://res.cloudinary.com/dleeu99na/image/upload/v1593753249/personal%20website/Images/linkden-icon.png";
let instaIcon = "https://res.cloudinary.com/dleeu99na/image/upload/v1593753249/personal%20website/Images/insta-icon.png";
let githubIcon = "https://res.cloudinary.com/dleeu99na/image/upload/v1644012485/personal%20website/Images/githubicon.png";
...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    setBorderRadius();
    const intervalId = setInterval(setBorderRadius, 1500);

    if (document.getElementsByClassName("Loading-container")[0] !== undefined) {
      document.getElementsByClassName("Loading-container")[0].style.transitionDuration = "0.4s";
      document.getElementsByClassName("Loading-container")[0].style.top = "-10vh";

      setInterval(function () {
        if (document.getElementsByClassName("Loading-container")[0] !== undefined) {
          document.getElementsByClassName("Loading-container")[0].style.transitionDuration = "1s";
          document.getElementsByClassName("Loading-container")[0].style.top = "-110vh";
        ...
        <div className="rightBar">
          ...
          <nav className="navbar-container">
            <div className="hamburger">
              ...
              <div className="bubble-wrap" onClick={hamburgerClick}>
          ...
          <div className="social-icon-container">
            <div className="social-media-icon">
              <a href="https://api.whatsapp.com/send?phone=+917977905493" target="_blank" rel="noopener noreferrer">
                <img src={WhatsappIcon} alt="Whatsapp Icon" />
              </a>
            </div>

            <div className="social-media-icon">
              <a href="https://www.instagram.com/avishkadakia" target="_blank" rel="noopener noreferrer">
                <img src={instaIcon} alt="Instagram Icon" />
              </a>
            </div>
            <div className="social-media-icon">
              <a href="https://www.linkedin.com/in/avish-kadakia-3a6591116" target="_blank" rel="noopener noreferrer">
                <img src={linkedinIcon} alt="linkedin Icon" />
              </a>
            </div>
            <div className="social-media-icon">
              <a href="https://github.com/AvishKadakia" target="_blank" rel="noopener noreferrer">
                <img src={githubIcon} alt="Github Icon" />
              </a>
            </div>
            <div className="social-media-icon">
              <a href="https://drive.google.com/file/d/1JWyuofeRSxZ_ZYYDSMxQbg6zd3OYZeeB/view?usp=sharing">
